...
to_train_feature_filename = DataHome + "CIFAR_train4_feature.csv"
to_valid_feature_filename = DataHome + "CIFAR_valid1_feature.csv"
from_feature_filename = DataHome + "train_feature_Cls_pixelv.csv"
to_feature_rate = [0.8, 0.2]
...
train_index_list = random.sample(range(len(features_list)), int(len(features_list)*to_feature_rate[0]) )
train_features_list = []
