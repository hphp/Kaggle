...
2013-11-02
pca before all calculation to see how data changes.
the error rate comes up to 93 % , which is terrible.
...
def sgd_optimization_mnist(learning_rate=0.13, n_epochs=100,
    ...
    print n_valid_batches , n_test_batches
    ...
    classifier = LogisticRegression(input=x, n_in=10 * 10 , n_out=10)
