        ...
        for minibatch_index in xrange(n_train_batches):
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if this_validation_loss < best_validation_loss:
                    ...
                    best_iter = iter
                    list_best_classifier = [layer0,layer1,layer2,layer3]
                    classifier_file = open('tmp.file','w')
                    cPickle.dump(list_best_classifier,classifier_file)
