...
def load_data(dataset):
    ...
    test_set = read_test_data_to_ndarray("../data/test.csv",limit=28)
    valid_set = read_data_to_ndarray("../data/valid.csv",limit=100)
    train_set = read_data_to_ndarray("../data/train.csv",limit=100)
