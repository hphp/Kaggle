...
def load_data(dataset):
    ...
    test_set = tdtf.read_csv_data_to_ndarray(DataHome+"train.csv",limit=10)
    valid_set = tdtf.read_csv_data_to_ndarray(DataHome+"train.csv",limit=5000)
    train_set = tdtf.read_csv_data_to_ndarray(DataHome+"train.csv",limit=5000)
...
def sgd_optimization_mnist(learning_rate=0.13, n_epochs=100,
    ...
    classifier = LogisticRegression(input=x, n_in=92 * 92, n_out=2)
